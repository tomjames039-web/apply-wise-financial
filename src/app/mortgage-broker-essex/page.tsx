...
const testimonials = [
  {
    quote: "As first-time buyers in Chelmsford, we were overwhelmed by the process. Apply Wise made everything simple and found us a great rate. Couldn't recommend them more!",
    author: "Tom & Jessica H.",
    location: "Chelmsford, Essex",
    rating: 5,
  },
  {
    quote: "Running my own business in Colchester, I struggled to get a mortgage through the banks. Apply Wise understood self-employed income and got me approved in weeks.",
    author: "Richard M.",
    location: "Colchester, Essex",
    rating: 5,
  },
  {
    quote: "After being declined by our own bank in Southend, Apply Wise found a lender who approved our remortgage straight away. Brilliant local knowledge.",
...
const faqs = [
  {
    question: "Do I need to visit your office in Essex?",
    answer: "No, we offer a fully remote service. We can handle everything by phone, video call, and secure document upload. However, if you'd prefer to meet in person, we can arrange appointments at convenient locations across Essex.",
  },
  {
    question: "What areas of Essex do you cover?",
    answer: "We help clients across all of Essex including Chelmsford, Colchester, Southend, Basildon, Brentwood, Harlow, Epping, Loughton, and surrounding areas. We also cover neighbouring counties including Hertfordshire, Suffolk, and Greater London.",
  },
  {
    question: "How is Apply Wise different from other Essex mortgage brokers?",
    answer: "We're whole-of-market with access to 90+ lenders, meaning we can search the entire market to find you the best deal. Unlike tied advisers or banks, we're not limited to a small panel. Plus, our service is free for remortgages and product transfers with your existing lender.",
  },
  {
    question: "Can you help with buy-to-let properties in Essex?",
    answer: "Absolutely. Essex has a strong rental market, and we specialise in buy-to-let mortgages. Whether you're a first-time landlord or building a portfolio, we have access to competitive BTL rates and specialist lenders.",
  },
  {
    question: "How quickly can you arrange a mortgage?",
    answer: "We can often provide a Decision in Principle the same day. Full mortgage applications typically complete within 4-8 weeks, though this can vary depending on the lender and complexity of your case. We keep you updated throughout.",
  },
];
...
const services = [
  {
    ...
    description: "Helping Essex first-time buyers onto the property ladder with expert guidance and access to first-time buyer schemes.",
  ...
  {
    title: "Buy-to-Let",
    description: "Specialist BTL mortgages for Essex landlords. Personal name or limited company structures available.",
    link: "/buy-to-let",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: "Self-Employed",
    description: "Expert help for Essex business owners. We know how to present your income to get the best mortgage.",
    link: "/self-employed",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: "Bad Credit",
    description: "Specialist lenders for adverse credit. CCJs, defaults, and past issues don't have to stop you.",
    link: "/bad-credit",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: "Life insurance, critical illness, and income protection to safeguard your Essex home and family.",
    link: "/protection",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export default function MortgageBrokerEssexPage() {
      ...
      <section className="relative min-h-[70vh] flex items-center bg-pearl pt-32 pb-16">
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Whole-of-market mortgage advice for buyers and homeowners across Essex. From Chelmsford to Colchester, Southend to Epping — we're here to help.
            </motion.p>
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  <h2 className="text-2xl md:text-3xl font-bold text-navy mb-6">
                    Why Choose a Local Essex Mortgage Broker?
                  </h2>
                  <div className="space-y-4 text-navy/70">
                    <p>
                      The Essex property market has its own characteristics. Average house prices, new developments, commuter belts, and local economic factors all play a role in getting you the right mortgage.
                    </p>
                    <p>
                      Based in Epping, we understand the Essex market inside out. We know which lenders favour which areas, and how to present applications for maximum success.
                    </p>
                    <p>
                      But we're not limited by location. With access to 90+ UK lenders, we search the whole market to find you the best deal — combining local insight with national reach.
                    </p>
                  </div>
                </div>
                <div className="bg-pearl rounded-2xl p-8">
                  <h3 className="font-semibold text-navy mb-4">Essex Property Market</h3>
                  <div className="space-y-4">
                    {[
                      { label: "Average house price", value: "£385,000" },
                      { label: "Commuter links to London", value: "Excellent" },
                      { label: "First-time buyer activity", value: "High" },
                      { label: "Buy-to-let yields", value: "5-7%" },
                    ].map((stat) => (
        ...
        <div className="container mx-auto px-4 md:px-6">
          <ScrollAnimation>
            <div className="text-center mb-10">
              ...
              <p className="text-navy/60 max-w-xl mx-auto">
                We help clients across all of Essex and neighbouring counties
              </p>
            </div>
          </ScrollAnimation>
          ...
          <div className="max-w-2xl mx-auto text-center">
            <ScrollAnimation>
              ...
              <p className="text-white/60 mb-8">
                Speak to an Essex mortgage expert today. No obligation, no fees for advice.
              </p>
